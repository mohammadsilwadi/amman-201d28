...
an array where the first element is the sum of those numbers, and the second element is a concatenated string that EXACTLY 
...
let mulit=multiply(a,b);
let mulit2=multiply(mulit[0],c);
return[sum3[0],mulit2[0],`${a} and ${b} and ${c} sum to ${sum3[0]}.`,`The product of ${a} and ${b} and ${c} is ${mulit2[0]}.`];
}
...
and then returns an array where the first element is the sum of the numbers in the array, and the second element 
...
in this function. To do addition, use your sum() 
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
    ...
    }return[mul1,`The numbers ${dynamicArray[0]},${dynamicArray[1]},${dynamicArray[2]},${dynamicArray[3]},${dynamicArray[4]} have a product of ${mul1}.`];}
// Here is the test for multiplyArray(); uncomment it to run it
